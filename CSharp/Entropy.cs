...
namespace Cloakify
{
    public static class Entropy
    {
        ...
        public static string RemovePrefixNoise(string input, NoiseInputMode inputMode, char seperator)
        {
            if (inputMode == NoiseInputMode.Both || inputMode == NoiseInputMode.Input)
                input = File.ReadAllText(input);
        ...
        public static string AddPrefixNoise(string input, string entropy, NoiseInputMode inputMode, char seperator)
        {
            if (inputMode == NoiseInputMode.Both || inputMode == NoiseInputMode.Input)
                input = File.ReadAllText(input);
